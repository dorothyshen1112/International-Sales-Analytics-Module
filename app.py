...
with st.sidebar:
    ...
    if admin_mode:
        ...
        if pwd == "sunmax888":
            ...
            if st.button("更新快取"): st.cache_data.clear()
...
if df_all is not None:
    ...
    if not df.empty:
        ...
        with tabs[0]: # 修正版：上下排版確保長趨勢表不被切掉
            ...
            st.caption("💡 註：上升紅色、下降綠色、新市場顯示 '-'。")

        with tabs[3]: # 營運效率 (藍色說明框永久回歸)
